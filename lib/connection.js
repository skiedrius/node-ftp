...
FTP.prototype.connect = function(options) {
  ...
  this.options.socketKeepAlive = options.socketKeepAlive == null ? true : !!options.socketKeepAlive;
  ...
  socket.setTimeout(0);
  socket.setKeepAlive(this.options.socketKeepAlive);
